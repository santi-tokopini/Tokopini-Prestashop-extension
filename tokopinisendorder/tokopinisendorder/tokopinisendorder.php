...
class tokopinisendorder extends Module
{
	...
	protected $configOptions = array(
		...
		'TOKOPINI_ENABLE_SENDORDER_ERROR_LOG'
	);
	...
	public function displayForm()
	{
		...
		$fields_form[0]['form'] = array(
				...
				'input' => array(
						...
						$this->yesNoOption('TOKOPINI_ENABLE_SENDORDER_ERROR_LOG', 'Enable Error Logging:'),
						array(
								'type' => 'text',
